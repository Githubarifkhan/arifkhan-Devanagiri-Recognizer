...
model1 = load_model(r"C:\Users\arif0786\devanagari.h5")
print(model1)

def main():
     letter_count = {0: 'CHECK', 1:'01_ka', 2:'02_kha',3:'03_ga',4: '04_gha', 5: '05_kha', 6: 'character_06_cha',
     ...
     while (cap.isOpened()):
         ...
         if len(cnts) >= 1:
             ...
             if len(pts)!=0:
              ...
              pts = deque(maxlen=512)
              blackboard = np.zeroes((480, 640, 3), dtype =np.uint8)
